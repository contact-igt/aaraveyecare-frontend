    ...
    return (
        <>
            ...
            >
                ...
                {/* Tooltip — subtle pop out */}
                <span className="absolute right-16 bg-white text-[#25D366] px-3 py-1.5 rounded-lg text-sm font-bold shadow-xl border border-teal-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap">
                    Talk to Us
                </span>
            </a>
            ...
            {/* 3. Mobile Sticky Bottom Bar — visible only on mobile/tablet */}
